...
public sealed record ReorderAlertDto(int ProductId, string ProductName, int CurrentQuantity, int ThresholdQuantity, int ReorderQuantity, int? PreferredSupplierId);
