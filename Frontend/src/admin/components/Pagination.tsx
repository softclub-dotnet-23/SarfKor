...
export function Pagination({
  ...
  return (
    <div className="mt-4 flex items-center justify-between gap-3 border-t border-[color:var(--mod-border)] pt-4">
      <span className="font-[JetBrains_Mono,monospace] text-[11.5px] text-[color:var(--mod-faint)]">
      ...
      <div className="flex gap-2">
        <button
          ...
          disabled={!canPrev}
          className="flex h-8 items-center gap-1 rounded-lg border border-[color:var(--mod-border)] px-3 text-[12px] font-semibold text-[color:var(--mod-text)] transition-colors hover:bg-[color:var(--mod-panel2)] disabled:opacity-35"
        >
