                ...
                {stage === 'confirm' ? (
                  <>
                    ...
                    <button
                      ...
                      disabled={busy}
                      className="font-semibold text-white underline decoration-white/30 underline-offset-[6px] transition-all duration-500 hover:decoration-white disabled:opacity-50"
                    >
                      Отправить ещё раз
                    </button>
                    {' · '}
