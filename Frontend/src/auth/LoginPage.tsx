        ...
        <div className="flex flex-1 items-center justify-center px-6 pb-16">
          ...
          >
            <h2 className="mb-1.5 text-[24px] font-extrabold tracking-tight text-[color:var(--admin-text)]">
              {mode === 'login' ? 'Вход в панель' : 'Создать аккаунт'}
            </h2>
            <p className="mb-7 text-[14px] text-[color:var(--admin-text-tertiary)]">
              {mode === 'login'
                ? 'Войдите, чтобы управлять своим магазином'
                : 'После регистрации вы сможете создать магазин и получить доступ к панели партнёра'}
            </p>
              ...
              {mode === 'login' ? (
                <>
                  ...
                  <button
                    ...
                    className="font-semibold text-[color:var(--admin-accent)] hover:opacity-80"
                  >
                    Зарегистрироваться
                  </button>
                </>
