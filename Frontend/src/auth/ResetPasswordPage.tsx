...
export function ResetPasswordPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // 400 (invalid/expired token) and any other failure get the same generic message —
      // no reason to tell a caller which part of the link was wrong.
      setError(
          ...
          >
            {linkIncomplete ? (
              ...
              <>
                ...
                <p className="mb-7 text-[14px] text-[color:var(--admin-text-tertiary)]">Задайте новый пароль для {email}</p>
